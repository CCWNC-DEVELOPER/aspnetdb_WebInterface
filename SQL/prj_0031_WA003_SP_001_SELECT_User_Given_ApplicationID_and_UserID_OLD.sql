-- prj_0031_WA003_SP_001_SELECT_User_Given_ApplicationID_and_UserID.sql
...
alter PROCEDURE prj_0031_WA003_SP_001_SELECT_User_Given_ApplicationID_and_UserID(
	@ApplicationName AS nvarchar(256),
	@UserID AS NVARCHAR(37)
	)
	AS
...
WHERE	(
			...
			and
			 (aspnet_Users.UserID = @UserID_guid)
		)     